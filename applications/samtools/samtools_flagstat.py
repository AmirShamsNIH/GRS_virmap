...
def samtools_flagstat_script(general_Dict):
	"""
	...
	for each_input in general_Dict["INPUT"]:
		...
		IO_Dict["REPORT1"] = general_Dict["REPORT_PATH"] + PREFIX + ".samtools_flagstat.txt"
...
def build_samtools_flagstat_execution_script(general_Dict):
	"""
	"""
	execution_script = samtools_flagstat_script(general_Dict)
	return execution_script
# ################################### WILDCARDS ################################### #
# ################################### PIPELINE FLOW ############################### #
# ################################### PIPELINE RULES ############################## #
