...
def convert_to_csv(output_directory, mapping_Dict):
	...
	#print(dataframe)
	dataframe.to_csv(output_directory + "mapping_report.txt", sep="\t")
	return True
...
output_directry = sys.argv[2]
target_genome_string = sys.argv[3]
contamination_genome_string = sys.argv[4]

mapping_Dict = build_mapping_dict(mapping_Dict, report_directory, target_genome_string)
mapping_Dict = build_contamination_dict(mapping_Dict, report_directory, contamination_genome_string)

convert_to_csv(output_directry, mapping_Dict)
print("Done.")